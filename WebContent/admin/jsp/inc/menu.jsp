...
<nav class="navbar-default navbar-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav" id="main-menu">
			...
			<li class="${numberOfOrders != null ? 'active-link' : '' }"><a href="/eshop/admin/home"><i
					class="fa fa-desktop "></i>Quản lý chung</a>
			</li>

			<li><a href="/eshop/admin/notifications"><i class="fa fa-table "></i>Thông báo <span class="badge">New</span></a></li>


			<li class="${users != null ? 'active-link' : '' }"><a href="/eshop/admin/users-management"><i class="fa fa-qrcode "></i>Quản lý thành viên</a></li>
			<li class="${(orders != null || items != null) ? 'active-link' : '' }"><a href="/eshop/admin/orders-management"><i class="fa fa-bar-chart-o"></i>Quản lý hóa đơn</a></li>
